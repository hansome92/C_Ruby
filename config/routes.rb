...
Neighborly::Application.routes.draw do
  ...
  get '/fundraising',           to: 'static#fundraising',         as: :fundraising
  get '/crowdfunding',          to: 'static#crowdfunding',        as: :crowdfunding
  get "/about",                 to: "static#about",               as: :about
  get "/faq",                   to: "static#faq",                 as: :faq
  get "/starting",              to: "static#starting",            as: :starting
  get "/idea_concept",          to: "static#idea_concept",        as: :idea_concept
  get "/terms",                 to: "static#terms",               as: :terms
  get "/privacy",               to: "static#privacy",             as: :privacy
  get "/start",                 to: "projects#start",             as: :start
  get "/kontakt",               to: "static#kontakt",             as: :kontakt
  get "/datenschutz",           to: "static#datenschutz",         as: :datenschutz
  get "/agb",                   to: "static#agb",                 as: :agb
  get "/aup",                   to: "static#aup",                 as: :aup
