...
puts 'Creating Configuration entries...'
  ...
  {
    company_name: 'Contribute.de',
    host: 'localhost',
    base_url: 'http://www.contribute.de/',
    blog_url: 'http://blog.contribute.de/',
    base_domain: 'www.contribute.de',
    email_contact: 'info@contribute.de',
    email_payments: 'payment@contribute.de',
    email_system: 'no-reply@contribute.de',
    email_no_reply: 'no-reply@contribute.de',
    facebook_url: 'http://www.facebook.de/contributede',
    facebook_app_id: 157666047750885,
    twitter_username: 'contributede',
    platform_fee: 0.05,
    support_forum: 'http://support.contribute.de',
    project_finish_time: '02:59:59',
    secret_token: SecureRandom.hex(64),
    secret_key_base: SecureRandom.hex(64),
    currency_charge: 'EUR',
    google_analytics_id: 'SOMETHING',
    email_projects: 'info@contribute.de',
    timezone: 'Europe/Berlin',
    devise_secret_key: SecureRandom.hex(64),
    balanced_api_key_secret: 'ak-test-Mx17FhzbEVYLbFkIrsHPUTUgVRoezCni',
    ...
    #aws_access_key: nil,
    #aws_secret_key: nil,
    paypal_username: 'paypal_api1.viacarta.de',
    paypal_password: 'G6H4LYJMWH83TGS4',
    paypal_signature: 'AxBB0dbTEccakamK1Sx0D4s39l3xAA2GpldYg9qXfGXFi03gBvzNDqvk',
    #stripe_api_key: nil,
...
puts 'Creating State entries...'
  ...
  [[name: 'Baden-Württemberg', acronym: 'BW'],
  [name: 'Bayern', acronym: 'BY'],
  [name: 'Berlin', acronym: 'BE'],
  [name: 'Brandenburg', acronym: 'BB'],
  [name: 'Bremen', acronym: 'HB'],
  [name: 'Hamburg', acronym: 'HH'],
  [name: 'Hessen', acronym: 'HE'],
  [name: 'Mecklenburg-Vorpommern', acronym: 'MV'],
  [name: 'Niedersachsen', acronym: 'NI'],
  [name: 'Nordrhein-Westfalen', acronym: 'NW'],
  [name: 'Rheinland-Pfalz', acronym: 'RP'],
  [name: 'Saarland', acronym: 'SL'],
  [name: 'Sachsen', acronym: 'SN'],
  [name: 'Sachsen-Anhalt', acronym: 'ST'],
  [name: 'Schleswig-Holstein', acronym: 'SH'],
  [name: 'Thüringen', acronym: 'TH']].each do |item|
    State.create! item
  end
...
puts 'Creating Category entries...'
  ...
  categories = ["Armut & Hunger", "Babies, Kinder & Familie", "Beerdigungen & Gedenktafeln", "Bildung & Lernen", "Business & Start-ups", "Gemeinschaft & Nachbarn", "Gewaltopfer", "Hochzeiten & Flitterwochen", "Kunst, Musik & Film", "Medizin, Krankheit & Heilung", "Teams & Vereine", "Tiere & Haustiere", "Träume & Wünsche", "Unfälle & Notfälle"]
  categories.each do |c|
    Category.create! name_de: c, name_en: c
  end
